...
echo $LINE
opkg install https://github.com/picons/picons/releases/download/72/enigma2-plugin-picons-snp-full.100x60-86x46.light.on.transparent_2019-07-20--00-08-28_all.ipk --add-dest hdd:/media/hdd -d hdd --force-depends >/dev/null 2>&1
echo $LINE
echo $LINE
...
echo $LINE
opkg install https://github.com/picons/picons/releases/download/72/enigma2-plugin-picons-snp-full.220x132-220x132.light.on.transparent_2019-07-20--00-08-28_all.ipk --add-dest hdd:/media/hdd/SkyQ -d hdd --force-depends >/dev/null 2>&1
