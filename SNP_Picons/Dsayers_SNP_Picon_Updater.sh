...
echo $LINE
opkg install https://github.com/davesayers2014/Picon/blob/master/SNP_Picons/enigma2-plugin-picons-snp-full.100x60-86x46.light.on.transparent_2017-05-21--18-36-13_all.ipk?raw=true --force-depends >/dev/null 2>&1
...
echo $LINE
opkg install https://github.com/davesayers2014/Picon/blob/master/SNP_Picons/enigma2-plugin-picons-snp-full.220x132-220x132.light.on.transparent_2017-05-21--18-36-13_all.ipk?raw=true --force-depends >/dev/null 2>&1
