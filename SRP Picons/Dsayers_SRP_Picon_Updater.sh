...
echo $LINE
opkg install https://github.com/davesayers2014/Picon/blob/master/SRP%20Picons/enigma2-plugin-picons-srp-full.100x60-86x46.light.on.transparent_2017-08-02--21-55-37_all.ipk?raw=true --force-depends >/dev/null 2>&1
...
echo $LINE
opkg install https://github.com/davesayers2014/Picon/blob/master/SRP%20Picons/enigma2-plugin-picons-srp-full.220x132-220x132.light.on.transparent_2017-08-02--21-55-37_all.ipk?raw=true --force-depends >/dev/null 2>&1
