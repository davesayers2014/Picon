...
https://github.com/davesayers2014/Picon/blob/master/SRP%20Picons/enigma2-plugin-picons-snp-full.220x132-190x102.light.on.transparent_2017-05-09--01-51-03_all.ipk?raw=true --force-depends >/dev/null 2>&1
